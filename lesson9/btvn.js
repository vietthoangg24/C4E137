...
function Age50(){
    ...
    console.log("Số ng có tuổi lớn hơn 50: "+n);
}
...
function married (){
    ...
    for(let user of users){
        ...
        else if(user.is_married==true){
            m++;
        }
    }
    console.log("Số người chưa kết hôn :"+n);
    console.log("SỐ người đã kết hôn :" +m)
...
function job (){
    ...
    for(let user of users){
        ...
        else if(user.job=="Project Manager"){
            project_manager++;
        }
        else if(user.job=="Teacher"){
            teacher++;
        }
        else if(user.job=="Worker"){
            worker++;
        }
    }
   console.log("số người làm Dentist :"+dentist);
   console.log("số người làm Developer :"+developer);
   console.log("số người làm Doctor :"+doctor);
   console.log("số người làm Farmer :"+farmer);
   console.log("số người làm Project Manage :"+project_manager);
   console.log("số người làm Teacher :"+teacher);
   console.log("số người làm Worker :"+worker);
